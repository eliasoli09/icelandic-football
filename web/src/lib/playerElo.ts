...
export const PLAYER_BASE: Record<League, number> = { besta: 1500, lengjudeild: 1400, premier: 1500 }
/** goals and results in the second tier move the needle less */
export const LEAGUE_WEIGHT: Record<League, number> = { besta: 1, lengjudeild: 0.6, premier: 1 }
